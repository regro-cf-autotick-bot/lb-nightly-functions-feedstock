...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lb-nightly-functions-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14582&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lb-nightly-functions-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lb-nightly-functions` can be installed with:

```
conda install lb-nightly-functions
```

It is possible to list all of the versions of `lb-nightly-functions` available on your platform with:
